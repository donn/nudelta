    ...
    getLayout(mode) {
        ...
        return [
            ...
            [
                ...
                new Key({ id: "num7", label: "7", altLabel: "Home" }),
                new Key({ id: "num8", label: "8", altLabel: "↑" }),
                new Key({ id: "num9", label: "9", altLabel: "PgUp" }),
                new Key({
                    id: "plus",
                    label: "+",
                    height: 2.0,
            ...
            [
                ...
                new Key({ id: "num1", label: "1", altLabel: "End" }),
                new Key({ id: "num2", label: "2", altLabel: "↓" }),
                new Key({ id: "num3", label: "3", altLabel: "PgDn" }),
                new Key({
                    id: "enter",
                    label: "↩",
                    name: "Enter",
            ...
            [
                ...
                new Key({ id: "num0", label: "0", altLabel: "Ins" }),
                new Key({
                    id: "period",
                    label: ".",
                    name: "Period",
